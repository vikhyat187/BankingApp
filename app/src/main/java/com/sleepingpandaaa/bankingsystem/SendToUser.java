...
public class SendToUser extends AppCompatActivity {
    ...
    private void showData(String phonenumber) {
        ...
        Cursor cursor = new com.sleepingpandaaa.bankingsystem.DatabaseHelper(this).readselectuserdata(phonenumber);
    ...
    public void selectuser(int position) {
        ...
        Cursor cursor = new com.sleepingpandaaa.bankingsystem.DatabaseHelper(this).readparticulardata(selectuser_phonenumber);
        while(cursor.moveToNext()) {
            ...
            new com.sleepingpandaaa.bankingsystem.DatabaseHelper(this).insertTransferData(date, name, selectuser_name, transferamount, "Success");
            new com.sleepingpandaaa.bankingsystem.DatabaseHelper(this).updateAmount(selectuser_phonenumber, Dselectuser_remainingamount.toString());
            calculateAmount();
    ...
    private void calculateAmount() {
        ...
        new com.sleepingpandaaa.bankingsystem.DatabaseHelper(this).updateAmount(phonenumber, remainingamount);
    }
        ...
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        new com.sleepingpandaaa.bankingsystem.DatabaseHelper(SendToUser.this).insertTransferData(date, name, "Not selected", transferamount, "Failed");
